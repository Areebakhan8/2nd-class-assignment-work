...
var defination =
  "Variable are used to store diffrent type of data in typescript";
console.log(defination);
...
let username: string = "Areeba khan";
console.log("USERNAME:" + username);
let password: number = 1234;
console.log("PASSWORD:" + password);
let email: any = "areebanabeel123@gmail.com";
